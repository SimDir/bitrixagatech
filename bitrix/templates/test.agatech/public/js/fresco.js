(function($) {
	...
	Browser = function(i) {
		...
		return {
			...
			WebKit: i.indexOf("AppleWebKit/index.html") > -1 && t("AppleWebKit/index.html"),
			Gecko: i.indexOf("Gecko") > -1 && -1 === i.indexOf("KHTML") && t("rv:"),
			MobileSafari: !!i.match(/Apple.*Mobile.*Safari/),
			Chrome: i.indexOf("Chrome") > -1 && t("Chrome/index.html"),
			ChromeMobile: i.indexOf("CrMo") > -1 && t("CrMo/index.html"),
			Android: i.indexOf("Android") > -1 && t("Android "),
			IEMobile: i.indexOf("IEMobile") > -1 && t("IEMobile/index.html")
		}
	} (navigator.userAgent),
	Support = function() {
		function i(i) {
