		...
		methods = {
			...
			init: function(options) {
				...
				this.each(function() {
					...
					var $slider =					$(this),
						...
						$bullets_container = 		$(),
						mm = 						{},
						backup_img =				"images/backup_img.html",
						placeholder_img = 			"images/placeholder.html",
						css3properties =			{},
			...
			resize: function(id) {
				...
				if(data !== undefined)
				{
					...
					$left_wing.css({"width": wing_width-2,"height": slide_height-2});
					$right_wing.css({"width": wing_width-2,"height": slide_height-2});
